# Based on https://github.com/deepseek-ai/Janus/blob/main/janus/models/processing_vlm.py
# Need to be able to control system prompt in __call__
...
class VLChatProcessor(ProcessorMixin):
    ...
    def process_one(
        ...
        **kwargs,
        ...
        if prompt is None:
            if "\n\nAssistant:" in conversations[0]["content"]:
                raise ValueError("'\\n\\nAssistant:' appears in the user content; this breaks assistant-only loss")
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: forwarded to process_one
        ...
        prepare = self.process_one(
            prompt=prompt, conversations=conversations, images=images, **kwargs
        )
